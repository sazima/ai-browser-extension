...
const TRANSLATIONS = {
  en: {
    ...
    "settings.maxturns.hint": "Max steps before auto-stop (default 25)",
  ...
  "zh-CN": {
    ...
    "settings.maxturns.hint": "AI 最多执行多少步后强制停止（默认 25）",
  ...
  "zh-TW": {
    ...
    "settings.maxturns.hint": "AI 最多執行幾步後強制停止（預設 25）",
  ...
  ja: {
    ...
    "settings.maxturns.hint": "自動停止までの最大ステップ数（デフォルト 25）",
  ...
  ko: {
    ...
    "settings.maxturns.hint": "자동 중지 전 최대 단계 수 (기본값 25)",
